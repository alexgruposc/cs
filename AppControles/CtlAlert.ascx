<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlAlert.ascx.cs" Inherits="KRAFTSALES.AppControles.CtlAlert" %>
            ...
            <div class="alert">
                ...
                <div class="alert_bottom">
                    <div class="alert_bottom_button">
                        <asp:Button ID="btnOk" runat="server" AccessKey="O" SkinID="ButtonOk" Text="<%$ Resources:Resource, lblOk %>" ToolTip="<%$ Resources:Resource, lblOk %>" onclick="btnOk_Click"  />
                    </div>
                </div>
            </div>
        </asp:Panel>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlData.ascx.cs" Inherits="KRAFTSALES.AppControles.CtlData" %>
...
<asp:Panel ID="pnlCalendar" runat="server" Width="125px">
    <div style="display: table; width: 125px;">
        <div style="display: table-cell; width: 100px; height: auto; text-align: center; vertical-align: middle;">
            <asp:TextBox ID="txtData" runat="server" MaxLength="10" SkinID="Data"  AutoPostBack="true"

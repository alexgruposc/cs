<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlOption.ascx.cs" Inherits="KRAFTSALES.AppControles.CtlOption" %>
<asp:UpdatePanel ID="upAlert" runat="server">
    <ContentTemplate>
        <%-- PROGRESS BACKGROUND --%>
        <asp:UpdateProgress ID="upLoading" runat="server" AssociatedUpdatePanelID="upAlert">
            <ProgressTemplate>
                ...
                <div class="alert_bottom">
                    <div class="alert_bottom_button">
                        <div class="alert_bottom_button_left">
                            <asp:Button ID="btnYes" runat="server" AccessKey="S" SkinID="ButtonLeftOk" Text="<%$ Resources:Resource, lblSim %>" ToolTip="<%$ Resources:Resource, lblSim %>" onclick="btnYes_Click"  />
                        </div>
                        <div class="alert_bottom_button_right">
                            <asp:Button ID="btnNo" runat="server" AccessKey="N" SkinID="ButtonRightNaoOk" Text="<%$ Resources:Resource, lblNao %>" ToolTip="<%$ Resources:Resource, lblNao %>" OnClick="btnNo_Click" />
                        </div>
                    </div>
                </div>
            </div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlPeriodoB.ascx.cs" Inherits="KRAFTSALES.AppControles.CtlPeriodoB" %>
...
<asp:Panel ID="pnlPeriodo" runat="server" Width="360px">
    <div style="display: table;">
        ...
        <div style="display: table; width: 360px;">
            <div style="display: table-cell; width: 30px; height: 16px; vertical-align: middle;">
            ...
            <div style="display: table-cell; width: 100px; height: 16px; text-align: center; vertical-align: middle;">
                <asp:TextBox ID="txtInicio" runat="server" SkinID="txtBootstrap3" MaxLength="10" />
            </div>
            ...
            <div style="display: table-cell; width: 100px; height: 16px; text-align: center; vertical-align: middle;">
                <asp:TextBox ID="txtFim" runat="server" SkinID="txtBootstrap3" MaxLength="10" />
            </div>
            <div style="display: table-cell; width: 25px; height: 16px; text-align: center; vertical-align: middle;">

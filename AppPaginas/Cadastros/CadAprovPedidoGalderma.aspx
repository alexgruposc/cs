<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadAprovPedidoGalderma.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadAprovPedidoGalderma" %>
                                        ...
                                        <asp:Panel ID="pnlFiltros" runat="server" SkinID="PnlMenu">
                                            ...
                                            <div class="navegacaoX">
                                                ...
                                                <%--  <div class="boxPesquisa">
                                                            ...
                                                            <asp:DropDownList ID="ddFiltroEstabelecimento" runat="server"  Visible="false"  TabIndex="10"
                                                                AutoPostBack="True" SkinID="DropFiltro" />
                                                        </div>--%>
                                                <%--        <div class="boxPesquisa">
                                                    <asp:Label ID="lblFiltroUf" runat="server" Style="margin-left: 130px" />
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="cpfCnpj" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="faturarPara" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="Consultor" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="email" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="valorTotal" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="data_hora_criacao" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="dataFaturamento" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="DataBaixaPedido" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="TipoPedido" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />

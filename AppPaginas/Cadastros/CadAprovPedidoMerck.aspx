<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadAprovPedidoMerck.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadAprovPedidoMerck" %>
                                ...
                                <div style="display: table; text-align: center; width: 99%;">
                                    <div style="display: table; width: 100%;">
                                        <div class="boxPesquisa">
                                            <div class="line">
                                                <asp:Button ID="btnSalvar" runat="server" SkinID="ButtonLeftSave" OnClick="btnSalvar_Click" TabIndex="1" />
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                DataKeyNames="pedidoId,Cod_pedido,IdDistribuidor,Consultor,observacoes,data_hora_criacao,
                                            ...
                                            ,pedidoIdGerado,pedidoDataCadastro,condicaoPagamentoId,condicaoPagamentoDescricao,TipoPedido,descricao"

<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadAprovPedidosAmgen.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadAprovPedidosAmgen" %>
                                                    ...
                                                    <asp:Panel ID="pnlLinha3" runat="server">
                                                        ...
                                                        <div style="width: 530px; display: table-cell;">
                                                            ...
                                                            <asp:DropDownList ID="ddlHeaderUnidadeNegocio" runat="server" AutoPostBack="true"
                                                                SkinID="DropFiltro" />
                                                            <asp:RequiredFieldValidator ValidationGroup="Validacao" ID="RequiredFieldValidator6" runat="server" SetFocusOnError="true" CssClass="alert-text" Font-Bold="true" ForeColor="Red" ControlToValidate="ddlHeaderUnidadeNegocio" ErrorMessage="<%$ Resources:Resource, msgInformeUnidadeNegocio %>" />
                                        ...
                                        <div style="display: table; width: 99.6%; height: 40%;">
                                            ...
                                            <fieldset style="height: 100%; width: 99%; position: relative; _position: fixed;">
                                                <div style="height: 100%; overflow-x: none; overflow-y: scroll; margin-top: 5px; margin-bottom: 5px;">
                                                    ...
                                                    <center />
                                                    <asp:GridView ID="gvItens" runat="server" OnRowDataBound="gvItens_RowDataBound">
                                                        <Columns>
                                                            <asp:BoundField DataField="Ean" ItemStyle-Width="150px" />
                                                            <asp:BoundField DataField="Sku" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px" />
                                                            <asp:BoundField DataField="Nome" ItemStyle-Width="150px" />
                                                            <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtQuantidade" runat="server" Text='<%# Eval("Quantidade") %>' Font-Bold="true" MaxLength="9" />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                                                <ItemTemplate>
                                                                    <asp:HiddenField ID="hfValorUnitario" runat="server"
                                                                        Value='<%# Eval("Valor_unitario", "{0:n2}") %>' />
                                                                    <asp:TextBox ID="txtValorUnitario" runat="server" Text='<%# Eval("Valor_unitario", "{0:n2}") %>' SkinID="Currency100"
                                                                        Font-Bold="true" MaxLength="18" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                                                <ItemTemplate>
                                                                    <asp:HiddenField ID="hfValorTotal" runat="server"
                                                                        Value='<%# Eval("Valor_total", "{0:n2}") %>' />
                                                                    <asp:TextBox ID="txtValorTotal" runat="server" Text='<%# Eval("Valor_total", "{0:n2}") %>' SkinID="Currency100"
                                                                        Font-Bold="true" MaxLength="18" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                    ...
                                    <div class="painel_body">
                                        <fieldset>
                                            ...
                                            <div class="navegacao">
                                                ...
                                                <div class="boxPesquisa">
                                                    <asp:Label ID="lblFiltrosClienteRazaoSocialc" runat="server" />
                    ...
                    <fieldset>
                                                ...
                                                <div style="display: table; width: 100%;">
                                                    ...
                                                    <div class="navegacao">
                                                        ...
                                                        <div class="boxPesquisa text-left">
                                                            <asp:Label ID="lblDataImport" runat="server">Data de Importação</asp:Label>
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                DataKeyNames="cod_pedido,cnpj,forma,condicao,cep,logradouro,numero,complemento,cidade,uf"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="cod_pedido" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="pedidoDataCadastro" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="cnpj" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <%--  <asp:BoundField DataField="forma" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />--%>
                                    <asp:BoundField DataField="clienteRazaoSocial" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="cep" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="logradouro" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="numero" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="complemento" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="cidade" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="uf" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />

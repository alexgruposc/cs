<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadAprovarPrePedidoIntegracao.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadAprovarPrePedidoIntegracao" %>
                                ...
                                <div style="width: 30%; display: table-cell;">
                                    <fieldset>
                                        ...
                                        <div style="display: table;">
                                            <div>
                                                <asp:Label runat="server">Pre-pedido Id</asp:Label>
                                                <asp:Label ID="lblHeaderPedidoIdDescricao" runat="server" ForeColor="Blue" />
                                            </div>


                                            <div>
                                                <asp:Label ForeColor="Blue" runat="server">Status Pedido:</asp:Label>
                                                <asp:Label ID="lblHeaderStatusPedido" runat="server" ForeColor="Blue" />
                                            </div>
                                            ...
                                            <asp:Panel ID="pnlLinha1" runat="server">
                                                ...
                                                <asp:Panel ID="pnlHeaderCliente" runat="server">
                                                    <fieldset>
                                                        ...
                                                        <asp:HiddenField ID="hdSistemaEntrada" runat="server" />
                                                        <asp:HiddenField ID="hdCOndPagID" runat="server" />
                                                                ...
                                                                <div style="width: 40%; display: table-cell;">
                                                                    <ol>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <asp:TextBox ID="txtDadosClienteWfEndereco" runat="server" TabIndex="63" MaxLength="40" Enabled="false" />
                                                                        </li>
                                                ...
                                                <div style="width: 100%; display: table;">
                                                    <asp:Panel ID="pnlLinha3" runat="server">
                                                        <div style="width: 500px; display: table-cell;">
                                                            ...
                                                            <asp:DropDownList ID="ddlHeaderTipoPedido" runat="server" SkinID="DropFiltro" Enabled="false" AutoPostBack="true" />
                                                            ...
                                                            <span id="spToolTip" style="DISPLAY: none; Z-INDEX: 100; POSITION: absolute; HEIGHT: 10px; z-index: 100;"></span>
                                    ...
                                    <asp:Panel ID="pnlGvItens" runat="server" Visible="true">
                                        <div style="display: table; width: 99.6%; height: 40%;">
                                            ...
                                            <fieldset style="height: 100%; width: 99%; position: relative; _position: fixed;">
                                                <div style="height: 100%; overflow-x: hidden; overflow-y: scroll; margin-top: 5px; margin-bottom: 5px;">
                                                    ...
                                                    <asp:GridView ID="gvItens" runat="server" TabIndex="51"
                                                      ...
                                                      familiaMaterialId,fabricanteId,unidadeNegocioId,estabelecimentoId,clienteIdERP,itemInfComplementar,valDescontoEmissao,itemTipoPedido"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-VerticalAlign="Middle" HeaderText="Qtd Aprov." ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtQtdAprovada" runat="server" SkinID="Currency50" AutoPostBack="true" Font-Bold="true" MaxLength="9" OnTextChanged="txtQtdAprovada_TextChanged" />
                                                                </ItemTemplate>
                                ...
                                <div style="display: table; text-align: center; width: 99%;">
                                    <div style="width: 100%; margin-top: 10px;">
                                        ...
                                        <asp:Panel ID="pnlFiltros" runat="server" SkinID="PnlMenu">
                                            ...
                                            <div>
                                                <div class="boxPesquisa">
                                                    <asp:Label ID="Label5" runat="server" Style="margin-left: 18px">Pedido Kraft ID</asp:Label>
                                                    <asp:TextBox ID="txtFiltroPedidoKraftId" runat="server" TabIndex="3" SkinID="Size70" />
                                                </div>
                                                <div class="boxPesquisa">
                                                    <asp:Label runat="server" Style="margin-left: 18px">Pré-Pedido ID</asp:Label>
                                                    <asp:TextBox ID="txtFiltroPedidoId" runat="server" TabIndex="3" SkinID="Size70" />
                                                </div>
                                                <div class="boxPesquisa">
                                                    <asp:Label ID="Label2" runat="server" Style="margin-left: 18px">CPF</asp:Label>
                                                    <asp:TextBox ID="txtFiltroCPF" runat="server" TabIndex="3" SkinID="Size70" />
                                                </div>
                                                <div class="boxPesquisa">
                                                    <asp:Label ID="Label3" Text="Status" runat="server" Style="margin-left: 18px" />
                                                    <asp:DropDownList runat="server" ID="txtFiltroStatus" SkinID="DropFiltro">
                                                        <asp:ListItem Text="SELECIONE.." Value="SELECIONE.." />
                                                        <asp:ListItem Text="AGUARDANDO APROVACAO" Value="1" />
                                                        <asp:ListItem Text="APROVADO" Value="2" />
                                                        <asp:ListItem Text="REPROVADO" Value="3" />
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="boxPesquisa">
                                                    <asp:Label ID="Label1" Text="Projeto" runat="server" Style="margin-left: 18px" />
                                                    <asp:DropDownList runat="server" ID="txtFiltroProjeto" SkinID="DropFiltro">
                                                        <asp:ListItem Text="SELECIONE.." />
                                                        <asp:ListItem Text="Delife" />
                                                        <asp:ListItem Text="Teva" />
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="boxPesquisa">
                                                    <asp:Label ID="Label4" Text="Data Pedido" runat="server" />
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                DataKeyNames="pedidoId
                                            ...
                                            ,condicaoPagamentoId
                                            ,pedidoObservacoes
                                            ,pedidoObservacoesNotaFiscal
                                            ,pedidoStatus
                                            ,pedidoIdGerado,dataPedido, dataAprovacao, usuarioAprovacao, clienteCPF, clienteCNPJ"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Pre-Pedido" DataField="pedidoId" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField HeaderText="Data do Pedido" DataField="dataPedido" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField HeaderText="Projeto" DataField="projeto" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField HeaderText="Cpf" DataField="clienteCPF" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />

                                    <asp:BoundField HeaderText="Pedido Status" DataField="pedidoStatus" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField HeaderText="Pedido Gerado" DataField="pedidoIdGerado" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField HeaderText="Data Aprovação" DataField="dataAprovacao" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    <asp:BoundField HeaderText="Usuário Aprovação" DataField="usuarioAprovacao" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                            ...
                            <div class="bs-example-modal-lg">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div style="width: 100%; height: 100%; display: table; margin-bottom: 10px">
                                                <div style="display: table-cell; width: 30%;">
                                                        ...
                                                        <div style="width: 50%; display: table-cell;">
                                                            ...
                                                            <ol>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <asp:TextBox ID="txtDadosClienteTipoEnderecoConf" runat="server" MaxLength="9" TabIndex="60" Enabled="false"></asp:TextBox>
                                                                ...
                                                                <li>
                                                                    <asp:Panel ID="Panel1" runat="server">
                                                                        ...
                                                                        <asp:ImageButton ID="imbBuscaCepConf" runat="server" Width="25px" Height="25px"
                                                                            ...
                                                                            ImageUrl="~/Imagens/find.png"
                                                                            OnClick="imbBuscaCepConf_Click" />
                                                                    </asp:Panel>
                                                                </li>
                                                                <li>
                                                                    <asp:Label ID="lblDadosClienteWfEnderecoConf" runat="server" SkinID="LabelForm" />
                                                                    <asp:TextBox ID="txtDadosClienteWfEnderecoConf" runat="server" TabIndex="63" MaxLength="40" />
                                                                </li>
                                                        ...
                                                        <div style="width: 40%; display: table-cell;">
                                                            <ol>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <asp:TextBox ID="txtDadosClienteWfEnderecoCad" runat="server" TabIndex="63" MaxLength="40" />
                                                                </li>

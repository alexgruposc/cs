<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadConfigClienteMerck.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadConfigClienteMerck" %>
            ...
            <asp:Panel ID="pnlDados" runat="server">
                <asp:UpdatePanel ID="uppDados" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Configuração de Fabricante Merck
                                </h2>
                                ...
                                <div class="modal-dialog modal-md">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <asp:Button ID="btnClickGrid" runat="server" Style="display: none" Text="" />
                                        </div>
                                    </div>

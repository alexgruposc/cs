<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadFormaEnvioLicitacao.aspx.cs" Inherits="KRAFTSALES.AppPaginas.CadFormaEnvioLicitacao" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlDados" runat="server" Width="100%" Height="100%" Visible="false">
                    <div style="width: 100%; height: 53px; display: table;">
                        ...
                        <fieldset>
                            <legend>Nova Forma de Envio</legend>
                ...
                <asp:Panel ID="pnlGrid" runat="server" DefaultButton="btnFiltrosPesquisa" Width="100%" Height="100%">
                    <fieldset>
                        <legend>Cadastro de Forma Envio
                        </legend>
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                DataKeyNames="formaEnvioId, descricao"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="formaEnvioId" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imbExcluir" runat="server" CommandName="Excluir" SkinID="modalidadeLicitacaoId"
                                                ToolTip="<%$ Resources:Resource, lblNaoOk %>" CommandArgument='<%#   Eval("formaEnvioId") + "|" + Eval("descricao") %>'

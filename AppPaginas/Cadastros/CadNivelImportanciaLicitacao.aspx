<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadNivelImportanciaLicitacao.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadNivelImportanciaLicitacao" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlDados" runat="server" Width="100%" Height="100%" Visible="false">
                    <div style="width: 100%; height: 53px; display: table;">
                        ...
                        <fieldset>
                            <legend>Novo Nivel de Importancia</legend>
                            <div style="display: table; width: 100%; height: 43px">

                                <div class="boxPesquisa" style="margin: 0 0 0 0">
                                    <asp:Label ID="lblCadDescricao" Text="Descricão: " runat="server" />
                                    <asp:TextBox ID="txtCadDescricao" runat="server" Width="500px" MaxLength="50" />
                                </div>
                ...
                <asp:Panel ID="pnlGrid" runat="server" DefaultButton="btnFiltrosPesquisa" Width="100%" Height="100%">
                    <fieldset>
                        <legend>Cadastro de Nivel de Importancia
                        </legend>
                                                ...
                                                <div style="display: table; width: 100%;">
                                                    ...
                                                    <div class="navegacao">
                                                        <div class="boxPesquisa">
                                                            <asp:Label ID="lblformaEnvioId" Text="Codigo" runat="server" />
                                                            <asp:TextBox ID="txtformaEnvioId" onkeypress="return isNumberKey(event)" runat="server" SkinID="SmallFilter" TabIndex="3" />
                                                        </div>
                                                        <div class="boxPesquisa">
                                                            <asp:Label ID="lblPequisaDescricao" Text="Descricao" runat="server" />
                                                            <asp:TextBox ID="txtPesquisaDescricao" runat="server" TabIndex="4" />
                                                        </div>
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                DataKeyNames="nivelImportanciaId, descricao"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="nivelImportanciaId" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" />
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imbExcluir" runat="server" CommandName="Excluir" SkinID="nivelImportanciaId"
                                                ToolTip="<%$ Resources:Resource, lblNaoOk %>" CommandArgument='<%#   Eval("nivelImportanciaId") + "|" + Eval("descricao") %>'

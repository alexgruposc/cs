<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" ClientIDMode="AutoID"
    MaintainScrollPositionOnPostback="true" CodeBehind="CadPedido.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadPedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function InitializeRequest(sender, args) {
            ...
            if (postBackElement.id == '<%= btnImportacao.ClientID %>') {
                document.getElementById('<%= upLoading.ClientID %>').style.display = 'block';
            ...
            <ContentTemplate>
                    ...
                    <fieldset style="margin-bottom: 110px; left: 0.1%; width: 99%; height: 100%;">
                                ...
                                <div style="width: 100%; margin-top: 10px;">
                                    ...
                                    <asp:Panel ID="pnlFiltros" runat="server" SkinID="PnlMenu">
                                        <div style="display: table; text-align: center; width: 99%;">
                                            ...
                                            <div style="display: table; width: 100%;">
                                                <div class="navegacao">
                                                    <div id="Div1" runat="server" class="boxPesquisa">
                                                        <asp:Label ID="lblFiltroPedNumeroClienteIntegracao" runat="server" />
                                                        <asp:TextBox ID="txtFiltroPedNumeroClienteIntegracao" runat="server" TabIndex="11" SkinID="SmallFilter" MaxLength="30" />
                                                    </div>
                                                    ...
                                                    <div class="boxPesquisa">
                                                        <asp:Label ID="lblFiltroOrigemPedido" runat="server" />
                                                        <asp:DropDownList ID="dplFiltroOrigemPedido" runat="server" SkinID="DropSmallFilter" TabIndex="16" />
                                                    </div>
                                                    <div class="boxPesquisa">
                                            ...
                                            <div style="display: table; width: 100%; text-align: right;">
                                                ...
                                                <div class="boxPesquisa">
                                                    ...
                                                    <asp:Label ID="lblPedidoBionexoFiltro" runat="server" Text='<%$ Resources:Resource, lblBionexo %>' />
                                                    <asp:CheckBox ID="chkPedidoBionexoFiltro" runat="server" />
                                                    ...
                                                    <asp:Label ID="lblPedidoEDI" runat="server" Text='<%$ Resources:Resource, lblPedidoEDI %>' />
                                                    <asp:CheckBox ID="chkPedidoEDI" runat="server" AutoPostBack="true" OnCheckedChanged="chkPedidoEDI_CheckedChanged" />
                                                    <asp:Label ID="lblPedidoFidelizeCA" runat="server" Text="<%$ Resources:Resource, lblPedidoFidelizeCA %>" />
                                                    <asp:CheckBox ID="chkPedidoFidelizeCA" runat="server" />

                                                    <asp:Label ID="lblSistemaEntradaEDI" runat="server" Text='<%$ Resources:Resource, lblSistemaEntradaEDI %>' Visible="false" />
                                                    <asp:DropDownList ID="dplLaboratorio" SkinID="DropFiltro" runat="server" Visible="false" />
                                                </div>
                        ...
                        <div class="gridRegistros" style="margin-top: 10px; margin-bottom: 10px;">
                            ...
                            <%--<asp:GridView ID="gvRegistros" runat="server" TabIndex="24" DataKeyNames="pedidoId,representanteNome,clienteId,representanteId,estabelecimentoId,
                                ...
                                observacaoBCare,pedidoIntegraFuncional,reservaid,notaFiscalNumeroTransf,notaFiscalSerieTransf,clienteGrupoComercialNome,clienteContribuinteICMS,DataAgendamentoInteg,PedidoAgendado, pedidoDataLiberacaoImplantacao,
                                clientegrupoativo,transportadoraEmergencial,transportadoraOrcamento,pedidoIntegraMerck,PedidoAmil,pedidoGalderma,RetiraBalcao,FLGPD,DTACT,HRACT,IPACT,pedidoReversoAcessar,Autoriza_Antibiotico,Autoriza_Imunosupressor,BloqueiaPedido,pedidoNumeroCliente,sistemaEntrada,OperadoraFidelize,PrazoHoras,DataExpedicao,CaixaRetornavel,pedidoLinkReceita"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                         ...
                                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrSistemaEntrada" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="24" DataKeyNames="pedidoId,PagamentoCartao,clienteRazaoSocial,clienteId,empenhoClientePrincipal,contratoLicitacaoSeq,contratoLicitacaoId,empenhoId,estabelecimentoId,tipoPedidoId,sistemaEntrada,SevenPDVPedidoIntegra,SevenPDVEfetivado,SevenPDVNrLocal,SevenPDVNrCentral,tagPgto,pedidoIdHistorico"
                                OnPageIndexChanging="gvRegistros_PageIndexChanging" OnRowCommand="gvRegistros_RowCommand"
                                OnRowDataBound="gvRegistros_RowDataBound" OnRowDeleting="gvRegistros_RowDeleting"
                                OnRowUpdating="gvRegistros_RowUpdating">
                                <Columns>
                ...
                <asp:Panel ID="pnlDados" runat="server" Visible="false">
                    <fieldset style="margin-bottom: 80px; margin-left: 0px; left: 0.5%; height: auto; width: 99%;">
                            ...
                            <div style="width: 100%; padding-bottom: 3px; display: table;">
                                ...
                                <div style="text-align: left; padding-right: 5px; display: table; width: 100%;">
                                    <div style="width: 100%; display: table;">
                                        ...
                                        <div style="width: 25%; display: table-cell; vertical-align: middle;">
                                        ...
                                        <div style="width: 8%; display: table-cell; text-align: center; vertical-align: middle;">
                                            <asp:Label ID="lblHeaderDataImplantacao" runat="server" />
                                        </div>
                                        <div style="width: 10%; display: table-cell; text-align: right; vertical-align: middle;">
                                            <asp:Label ID="lblHeaderDataImplantacaoDescricao" runat="server" ForeColor="Blue" />
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: table; width: 100%;">
                                        ...
                                        <div style="text-align: right; display: table-cell; width: 25%;" id="divBuscaPedidoParaCopia" runat="server">
                                            ...
                                            <div style="width: 100%; display: table; text-align: right; height: 100%;">
                                                <div style="width: 30%; display: table-cell; text-align: left; vertical-align: middle;">
                                                    <asp:Label ID="lblOrigemPedido" runat="server" />
                                                </div>
                                                <div style="width: 7%; display: table-cell; text-align: center; vertical-align: middle;">
                                                    <asp:Label ID="lblOrigemPedidoValor" runat="server" ForeColor="Blue" />
                                                </div>
                                        ...
                                        <div style="text-align: right; display: table-cell; width: 50%; vertical-align: middle;">
                                            ...
                                            <asp:Button ID="btnReenviarFidelize" runat="server" SkinID="ButtonRightVoltar" Visible="false" TabIndex="9" OnClick="btnReenviarFidelize_Click" />
                                        </div>
                                        ...
                                        <li>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="width: 20%">
                                                        <asp:Label ID="lblOperadoraFidelize" runat="server" Width="100px" />
                                                        <asp:DropDownList ID="ddlOperadoraFidelize" runat="server" SkinID="DropFiltro" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </li>
                                        ...
                                        <fieldset>
                                            <ol>
                                                <li>
                                                    ...
                                                    <asp:ImageButton ID="imgReceitaB2C" runat="server" Width="25px" Height="25px" Visible="false"
                                                        ImageAlign="AbsMiddle" TabIndex="23" ImageUrl="~/Imagens/medicamento.png" OnClick="imgReceitaB2C_Click" />
                                                </li>
                                                ...
                                                <div style="display: table; width: 100%; height: 30px;">
                                                    <div style="display: table-cell; vertical-align: middle; width: 300px; height: 100%;">
                                                        ...
                                                        <asp:ImageButton ID="btnImportacao" runat="server" Width="25px" OnClick="btnImportacao_Click"
                                                            ...
                                                            ToolTip="<%$ Resources:Resource, lblImportacaoCSV %>" Visible="false" />
                                                    </div>
                                    ...
                                    <div style="display: table; width: 100%; height: 100%;">
                                        ...
                                        <div style="display: table-cell; width: 10%; height: 30px; vertical-align: middle; text-align: right;">
                                            <asp:CheckBox ID="chkPedidoReversoAcessar" runat="server" Font-Bold="true" AutoPostBack="true" Text="Integração Acessar"
                                                TabIndex="24" OnCheckedChanged="chkPedidoReversoAcessar_CheckedChanged" />
                        ...
                        <asp:Panel ID="pnlIndicacaoEmbalagem" runat="server" Visible="false">
                            <div style="display: table; width: 100%; height: 20px;">
                                <fieldset>
                                    <div style="display: table; width: 100%; height: 100%;">
                                        <div style="display: table-cell; width: 8%; height: 30px; vertical-align: middle; text-align: center;">
                                            <asp:CheckBox ID="chkLaudo" runat="server" Font-Bold="true" TextAlign="Right" Enabled="false" />
                                        </div>
                                        <div style="display: table-cell; width: 8%; height: 30px; vertical-align: middle; text-align: center;">
                                            <asp:CheckBox ID="chkTermometro" runat="server" Font-Bold="true" TextAlign="Right" Enabled="false" />
                                        </div>
                                        <div style="display: table-cell; width: 8%; height: 30px; vertical-align: middle; text-align: center;">
                                            <asp:CheckBox ID="chkCaixasCarimbadas" runat="server" Font-Bold="true" TextAlign="Right" />
                                        </div>
                                        <div style="display: table-cell; width: 8%; height: 30px; vertical-align: middle; text-align: center;">
                                            <asp:CheckBox ID="chkCaixaRetornavel" runat="server" Font-Bold="true" TextAlign="Right" Enabled="false" />
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div style="height: 100%; overflow-x: none; overflow-y: scroll; margin-top: 5px; margin-bottom: 5px;">
                                        ...
                                        <asp:GridView ID="gvItens" runat="server" TabIndex="51"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPercentualOD" runat="server"
                                                            Font-Bold="true"
                                            ...
                                            <div class="gridRegistros">
                                                <asp:GridView ID="gvItensPesquisa" runat="server" TabIndex="55"
                                                    DataKeyNames="itemId,itemDescricao,itemInfComplementar,itemPesoBruto,itemPesoLiquido,itemRefrigerado,itemControlado,
                                                                ...
                                                                coeficienteDesconto,convenio87,tabelaPrecoImportacaoId,coeficienteTribEstab,ItemTipoCarga"
                                    ...
                                    <div class="painel_body" style="height: 75%;">
                                        <fieldset>
                                            ...
                                            <ol style="width: auto;">
                                                ...
                                                <li>
                                                    <asp:Label ID="lblMotivoReprovPedido" runat="server" SkinID="LabelForm" />
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <asp:Panel ID="pnlCondicaoPagamentoDepositoDados" runat="server">
                                                            <fieldset style="position: relative; height: 60%;">
                                                                <legend>
                                        ...
                                        <div class="gridRegistros">
                                            <asp:GridView ID="gvEmpenhoItens" runat="server"
                                                DataKeyNames="contratoLicitacaoId,clienteId,estabelecimentoId,contratoLicitacaoSeq,empenhoCodigoId,itemId,familiaComercialDescricao,empenhoItemQtd,
                                                                        ...
                                                                        empenhoItemSaldo,coeficienteDesconto,contribuinte,contratoLicitacaoData,convenio87,itemInfComplementar,codidentific,itemRefrigerado,ItemTipoCarga"
    ...
    <asp:UpdatePanel ID="updModalReceitaB2C" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlModalReceitaB2C" runat="server" CssClass="Modal" Visible="false">
                <div class="bs-example-modal-lg">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">

                            <div class="modal-header">
                                <asp:ImageButton ID="btnFecharModalReceitaB2C" runat="server" SkinID="ImgClose" ImageAlign="AbsMiddle" Width="25px" Height="25px"
                                    ToolTip="<%$ Resources:Resource, lblFechar %>"
                                    ImageUrl="~/Imagens/Fechar.png"
                                    OnClick="btnFecharModalReceitaB2C_Click" />
                                <h4 class="modal-title" id="TitleModalReceitaB2C">Informações Receita </h4>
                            </div>
                            <div class="modal-body">

                                <asp:Panel ID="pnlPDFReceitaB2C" runat="server" Height="250">
                                    <%--<asp:Literal ID="ltEmbedReceitaB2C" runat="server" />--%>
                                </asp:Panel>
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button Text="Fechar" SkinID="BtnDanger" CommandArgument="ModalNF" ID="btnFecharModalReceitaB2C2" runat="server" OnClick="btnFecharModalReceitaB2C2_Click" />
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h1>
                                    <asp:Label ID="lblIncoPedidoAmil" runat="server" Text="" />
                                </h1>
                            </div>
                        </div>
                        <div class="modal-body">
                            <ol>
                                <li>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <asp:TextBox ID="txtPedidoCompraAmil" runat="server" Font-Bold="true" SkinID="txtBootstrap2" Width="150px" MaxLength="15" />
                                        <br></br>
                                    </div>
                                </li>
                            ...
                            <div class="modal-body">
                                <ol>
                                    <li>
                                        ...
                                        <div class="col-md-6">
                                            <asp:Label ID="lblPedidoCompraAmil" runat="server" Text="Xped" />
                                            <asp:TextBox ID="txtPedidoCompraAmil" runat="server" Font-Bold="true" SkinID="txtBootstrap2" Width="150px" MaxLength="15" />
                                            </br>   
                                        </div>
                                    </li>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <ol>
                                    ...
                                    <li>
                                        <asp:Panel ID="pnlErroMerck" runat="server" Visible="false">
                                            <fieldset>
                                                <legend>
                                                    <asp:Literal ID="Literal4" runat="server" Text="Erro Autorização" />
                                                </legend>
                                                <br></br>
                                                <div style="width: 100%; height: 98%; display: table;">
                                                    <div class="col-md-12">
                                                        <asp:Label ID="lblErroMerck" runat="server" SkinID="lblAlerta" Font-Size="Larger" Text="" />
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </asp:Panel>
                            ...
                            <div class="modal-footer">
                                <div class="text-center">
                                    <asp:Button ID="btnSeguiredidoMerck" runat="server" SkinID="BtnSuccess" OnClick="btnSeguiredidoMerck_Click" Text="Sim" Visible="false" />
                                    <asp:Button ID="btnCancelarPedidoMerck" runat="server" SkinID="BtnDanger" OnClick="btnCancelarPedidoMerck_Click" Visible="false" Text="Não" />
                                    <asp:Button ID="btnFecharModalMerck" runat="server" SkinID="BtnSuccess" OnClick="btnFecharModalMerck_Click" Text="Fechar" />
                                </div>
                                <%--<asp:Button ID="BtnSeguirPedido" runat="server" SkinID="BtnSuccess" OnClick="BtnSeguirPedido_Click" Text="Seguir " />--%>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <ContentTemplate>
            <script type="text/javascript">
                function showProgress() {
                    var updateProgress = $get("<%= uplModalUpload.ClientID %>");
                    updateProgress.style.display = "block";
                }
            </script>

            <asp:UpdateProgress ID="uplModalUpload" runat="server" AssociatedUpdatePanelID="updModalUpload">
                <ProgressTemplate>
                    <div class="ProgressBackGround"></div>
                </ProgressTemplate>
            </asp:UpdateProgress>
                    ...
                    <div class="modal-dialog modal-md">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <asp:Button ID="btnUpload" runat="server" SkinID="BtnPrimary" Text="<%$ Resources:Resource, lblCarregar %>" OnClick="btnUpload_Click" OnClientClick="showProgress()" />

...
<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" ClientIDMode="AutoID"
    MaintainScrollPositionOnPostback="true" EnableEventValidation="false" CodeBehind="CadPedidoAgrup.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadPedidoAgrup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //            btnclick = grid1.rows[i].cells[17].childNodes[1].id;
        //        }
        //    }
        //}
    ...
    <asp:Panel ID="pnlPedido" runat="server">
        <asp:UpdatePanel ID="uppPedido" runat="server" UpdateMode="Conditional">
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="chkBionexo" EventName="CheckedChanged" />
                <asp:AsyncPostBackTrigger ControlID="chkPedidoAmil" EventName="CheckedChanged" />

                <asp:AsyncPostBackTrigger ControlID="dlDetalhePedido" EventName="ItemCommand" />
            ...
            <ContentTemplate>
                    ...
                    <fieldset style="margin-bottom: 110px; left: 0.1%; width: 99%; Height: 100%;">
                                            ...
                                            <div style="display: table; width: 100%;">
                                                <div class="navegacao">
                                                    ...
                                                    <div class="boxPesquisa">
                                                        ...
                                                        <asp:Button ID="btnFiltrosNovoCadastro" runat="server" SkinID="ButtonRightNew" TabIndex="22"
                                            ...
                                            <div style="display: table; width: 100%; text-align: right;">
                                                <div id="dvHistorico" runat="server" class="boxPesquisa">
                                                    <asp:CheckBox ID="chkHistorico" runat="server"
                                                        ...
                                                        Font-Bold="true"
                                                        TextAlign="Left"
                                                        Text="<%$ Resources:Resource, lblHistorico %>"
                                                        OnCheckedChanged="chkHistorico_CheckedChanged" />
                                                </div>
                        ...
                        <div class="gridRegistros" style="margin-top: 10px; margin-bottom: 10px;">
                            ...
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="24" DataKeyNames="pedidoId,representanteNome,clienteId,representanteId,estabelecimentoId,
                                              ...
                                              UsuarioNome,condicaoPagamentoDescricao,pedidoData,pedidoObservacoes,medicoId,medicoConsProfissional,medicoCRM,medicoUFidCRM,vendaDireta,backOfficeConferencia,backOfficeReceita,
                                              ...
                                              pedidoIdHistorico,usuarioIdHistorico,dataAlteracao,pedidoAguardaCliente,pedidoPossuiReembolso,pedidoOrdemReserva,SevenPDVNrCentral,SevenPDVPedidoIntegra,SevenPDVEfetivado,SevenPDVFinalizado,SevenPDVCartaoNro,
                                              SevenPDVLote,SevenPDVCancelado,SevenPDVFinalizaLote,SevenPDVNrLocal,
                                              PharmaSystemNrCentral,PharmaSystemPedidoIntegra,PharmaSystemEfetivado,PharmaSystemFinalizado,PharmaSystemCancelado,PharmaSystemCartaoNro,PharmaSystemProjeto,clienteContribuinteICMS"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrPedidoSituacao" runat="server" Text='<%# FormataStringSaida(GetResourceValue(Eval("pedidoSituacao").ToString()), ddFiltroSituacao.SelectedItem.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" ItemStyle-Font-Bold="true">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbReservaRemanejar" runat="server"
                                                CommandName="ReservaRemanejar"
                                                ToolTip="<%$ Resources:Resource, lblReservaRemanejar %>"
                                                CommandArgument='<%# Eval("pedidoId") + "|" + 
                                                                                 Eval("usuarioId") + "|" + 
                                                                                 Eval("clienteRazaoSocial") + "|" + 
                                                                                 Eval("pedidoOrdemReserva") %>'
                ...
                <asp:Panel ID="pnlDados" runat="server" Visible="false">
                    <fieldset style="margin-bottom: 80px; margin-left: 0px; left: 0.5%; height: auto; width: 99%;">
                                    ...
                                    <div style="display: table; width: 100%;">
                                        ...
                                        <div style="text-align: right; display: table-cell; width: 25%;" id="divBuscaPedidoParaCopia" runat="server">
                                            <div style="width: 100%; display: table; text-align: right; height: 100%;">
                                                ...
                                                <div style="display: table-cell; text-align: right; height: 100%; vertical-align: middle;">
                                                    <div id="dvCopia" runat="server" style="display: none; vertical-align: middle;">
                                                        <asp:Panel ID="pnlCopia" Style="display: none;" runat="server" DefaultButton="btnBuscaPedidoParaCopia">
                                                    ...
                                                    <asp:Panel ID="pnlHeaderCliente" runat="server" DefaultButton="imbHeaderClienteCheck">
                                                        <div style="width: 500px; display: table;">
                                                            <div style="display: table-cell; width: 320px;">
                                                                ...
                                                                <asp:Label ID="lblHeaderCliente" runat="server" Width="100px" />
                                                                ...
                                                                <asp:ImageButton ID="imbHeaderHistoricoCliente" runat="server" Width="20px" Height="20px"
                                                                    ImageAlign="AbsMiddle" TabIndex="8" ImageUrl="~/Imagens/hourglass.png" ToolTip="Historico de Compra" OnClick="imbHeaderHistoricoCliente_Click" />
                                        ...
                                        <div style="width: 100%; display: table;">
                                            <asp:Panel ID="pnlLinha3" runat="server">
                                                ...
                                                <div style="width: 530px; display: table-cell;">
                                                    ...
                                                    <asp:Label ID="lblHeaderCreditoDisponivel" Visible="false" runat="server" Width="80px" />
                                                    <asp:Label ID="lblHeaderCreditoDisponivelValor" Visible="false" runat="server" />
                                                </div>
                                                    ...
                                                    <asp:Panel ID="pnlOrcamento" runat="server">
                                                        <div style="display: table; width: 100%;">
                                                            <div style="display: table-cell; width: 50%;">
                                                                ...
                                                                <asp:CheckBox ID="chkOrcamento" runat="server" Font-Bold="true" AutoPostBack="true" Visible="false" OnCheckedChanged="chkOrcamento_CheckedChanged" />
                                                            </div>
                                                ...
                                                <div style="display: table; width: 100%; height: 30px;">
                                                    <div style="display: table-cell; vertical-align: middle; width: 300px; height: 100%;">
                                                        ...
                                                        <ucc:AutoCompleteExtender ID="aceItem" runat="server"
                                                            ...
                                                            ServiceMethod="GetItensPedidoAgrup"
                                                        ...
                                                        <asp:ImageButton ID="btnImportacao" runat="server" Width="25px" OnClick="btnImportacao_Click"
                                                            Height="25px" ImageAlign="AbsMiddle" TabIndex="15" ImageUrl="~/Imagens/import-csv.png"
                            ...
                            <div style="display: table; width: 100%; height: 20px;">
                                <fieldset>
                                    <div style="display: table; width: 100%; height: 100%;">
                                        ...
                                        <%--        <div style="display: table-cell; width: 55%; height: 30px; vertical-align: middle; text-align: right;">
                                        ...
                                        <div style="display: table-cell; width: 13%; height: 30px; vertical-align: middle; text-align: center;">
                                            <asp:CheckBox ID="chkBionexo" runat="server" SkinID="Filtro" Font-Bold="true" TextAlign="Right" />
                                        </div>
                                        <div style="display: table-cell; width: 10%; height: 30px; vertical-align: middle; text-align: center;">
                                            <asp:CheckBox ID="chkPedidoAmil" runat="server" SkinID="Filtro" Font-Bold="true" TextAlign="Right" AutoPostBack="true" OnCheckedChanged="chkPedidoAmil_CheckedChanged" />
                            ...
                            <div style="display: table; width: 99.6%; height: 40%;">
                                ...
                                <fieldset style="height: 100%; width: 99%; position: relative; _position: fixed;">
                                    <div style="height: 100%; overflow-x: none; overflow-y: scroll; margin-top: 5px; margin-bottom: 5px;">
                                        ...
                                        <asp:HiddenField ID="hdIndexValor" runat="server" />
                                        <center />
                                        <asp:GridView ID="gvItens" runat="server" TabIndex="51"
                                            DataKeyNames="itemId,itemDescricao,unidadeMedidaSigla,familiaComercialDescricao,familiaMaterialDescricao,itemControladoValidado,informado,gravado,
                                                      ...
                                                      familiaMaterialId,fabricanteId,unidadeNegocioId,estabelecimentoId,clienteIdERP,itemInfComplementar,valDescontoEmissao,itemTipoPedido,itemConv118,itemIsentoIcms,itemCodigoOrigem,convenio87"
                                            ...
                                            <Columns>
                                                    ...
                                                    <ItemTemplate>
                                                        <%--<div style="width: 100%; display: table;">
                                                            <div style="width: 50%; vertical-align: middle; display: table-cell; text-align: right;">
                                                                <asp:LinkButton ID="lbItemId" runat="server" />
                                                            </div>
                                                        </div>--%>
                                                ...
                                                <asp:BoundField DataField="itemDescricao" ControlStyle-Width="100px" />
                                                ...
                                                <asp:BoundField DataField="familiaComercialDescricao" ItemStyle-Width="90px">
                                                ...
                                                <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                                                    <ItemTemplate>
                                                        <%-- <asp:UpdatePanel ID="updEstabelecimento" ChildrenAsTriggers="true" runat="server" UpdateMode="Conditional">
                                                            <Triggers>
                                                                <asp:AsyncPostBackTrigger ControlID="ddlEstabelecimento" EventName="SelectedIndexChanged" />
                                                            </Triggers>
                                                            <ContentTemplate>--%>

                                                        <asp:DropDownList ID="ddlEstabelecimento" runat="server" OnSelectedIndexChanged="ddlEstabelecimento_SelectedIndexChanged" AutoPostBack="true" SkinID="DropFiltro">
                                                        </asp:DropDownList>
                                                        <%--  </ContentTemplate>
                                                        </asp:UpdatePanel>--%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="90px">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hfValorDescontoTrib" runat="server"
                                                            Value='<%# Eval("valDescontoEmissaotrib", "{0:n2}") %>' />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="40px">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtValorDescontoBoleto" runat="server"
                                                            SkinID="Currency100" Font-Bold="true"  AutoPostBack="true" OnTextChanged="txtValorDescontoBoleto_TextChanged"
                                                            MaxLength="18" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblItemPercentualOD" runat="server"
                                                            Font-Bold="true"
                                                            ToolTip="<%$ Resources:Resource, lblValorDesconto %>"
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Lote" ItemStyle-Width="90px">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imbVisualizar" runat="server" SkinID="ImgGrid" CommandName="visualizarILote" ImageUrl="~/Imagens/find.png"
                                                ...
                                                <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"
                                                    ItemStyle-CssClass="hiddenColumn"
                                                    HeaderStyle-CssClass="hiddenColumn"
                                                    SortExpression="AddPedido">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imbCriarPedido" runat="server" SkinID="ImgGrid"
                                                            CommandName="CreatePedido"
                                                            ImageUrl="~/Imagens/find.png"
                                                            rel="<%# ((GridViewRow)Container).RowIndex  %>"
                                                            ToolTip='<%# Eval("itemId")  + "|" +  ((GridViewRow)Container).RowIndex %>'
                                                            AlternateText='<%# Eval("itemId")  + "|" +  ((GridViewRow)Container).RowIndex %>' />
                        ...
                        <asp:UpdatePanel ID="updPanelDetalhe" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Panel ID="pnlPedidoDetalhe" runat="server">
                                    <div style="opacity: 0; margin-left: -10px;">
                                    </div>
                                    <div style="display: table; width: 99.6%; height: 40%;">
                                        ...
                                        <fieldset style="height: 100%; width: 99%; position: relative; _position: fixed;">
                                            <div style="height: 100%; overflow-x: none; overflow-y: scroll; margin-top: 5px; margin-bottom: 5px;">
                                                ...
                                                <asp:DataList ID="dlDetalhePedido"
                                                    OnItemDataBound="dlDetalhePedido_ItemDataBound"
                                                    OnItemCommand="dlDetalhePedido_ItemCommand"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal_header">
                                                                    ...
                                                                    <div style="display: table; width: 100%; background-color: #13213C; border-radius: 5px;">
                                                                        <h4 class="modal-title">
                                                                            <div style="display: table-cell; vertical-align: middle; text-align: center;">
                                                                                <asp:Label ID="lblHeaderUF" runat="server" Font-Bold="true" ForeColor="White" Text='<%# Eval("estabelecimentoDesc") %>' />
                                                                            </div>
                                                                            <asp:LinkButton ID="lnkDetalhe" runat="server" CommandName="NewItem" CommandArgument='<%# Eval("pedidoId")   + "|" + Eval("estabelecimentoId") %>'>
                                                                                <asp:Image ID="imgDetalhe" runat="server" Width="20px" Height="20px" ImageAlign="Right" ImageUrl="~/Imagens/btnNew.png" />
                                                                            </asp:LinkButton>
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="form-horizontal">
                                                                        <div>
                                                                            <div id="dvNumeroPedido" runat="server" style="display: table; margin-bottom: 2px; width: 100%;">
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: left; width: 50%;">
                                                                                    <asp:Literal ID="ltrNumeroPedido" runat="server" Text='<%$ Resources:Resource, lblpedidoNumero %>' />
                                                                                </div>
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: right; width: 50%;">
                                                                                    <asp:Literal ID="ltrNumeroPedidoValor" runat="server" Text='<%# Eval("pedidoId") %>' />
                                                                                </div>
                                                                            </div>
                                                                            <div id="dvStatusPedido" runat="server" style="display: table; margin-bottom: 2px; width: 100%;">
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: left; width: 50%;">
                                                                                    <asp:Literal ID="ltrStatusPedido" runat="server" Text='<%$ Resources:Resource, lblStatus %>' />
                                                                                </div>
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: right; width: 50%;">
                                                                                    <asp:Literal ID="ltrStatusPedidoValor" runat="server" Text='<%# Eval("pedidoSituacao") %>' />
                                                                                </div>
                                                                            </div>
                                                                            <div id="dvQTDItem" runat="server" style="display: table; margin-bottom: 2px; width: 100%;">
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: left; width: 50%;">
                                                                                    <asp:Literal ID="ltrQtdItem" runat="server" Text='<%$ Resources:Resource, lblQtdTotalItens %>' />
                                                                                </div>
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: right; width: 50%;">
                                                                                    <asp:Literal ID="ltrQtdItemValor" runat="server" Text='<%# Eval("pedidoTotalItens") %>' />
                                                                                </div>
                                                                            </div>
                                                                            <div id="dvTotalPedido" runat="server" style="display: table; margin-bottom: 2px; width: 100%;">
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: left; width: 50%;">
                                                                                    <asp:Literal ID="ltrTotalPedido" runat="server" Text='<%$ Resources:Resource, lblTotalPedidoDetalhe %>' />
                                                                                </div>
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: right; width: 50%;">
                                                                                    <asp:Literal ID="ltrTotalPedidoValor" runat="server" Text='<%# Eval("pedidoValorTotal", "{0:n2}") %>' />
                                                                                </div>
                                                                            </div>

                                                                            <div id="dvValorFrete" runat="server" style="display: table; margin-bottom: 2px; width: 100%;">
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: left; width: 50%;">
                                                                                    <asp:Literal ID="ltrValorFrete" runat="server" Text='<%$ Resources:Resource, lblValorFrete %>' />
                                                                                </div>
                                                                                <div style="display: table-cell; vertical-align: middle; text-align: right; width: 50%;">
                                                                                    <asp:Literal ID="ltrValorFreteValor" runat="server" Text='<%# Eval("freteValorInformado", "{0:n2}") %>' />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <div style="display: table; width: 100%;">
                                                                        <asp:LinkButton ID="lnkExcluirDetalhe" runat="server" ToolTip="Excluir Pedido" CommandName="DeleteItem" CommandArgument='<%# Eval("pedidoId")   + "|" + Eval("estabelecimentoId") %>'>
                                                                            <asp:Image ID="imgExcluirDetalhe" runat="server" Width="20px" Height="20px" ImageAlign="Right" ImageUrl="~/Imagens/recycle.png" />
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div style="left: 0.5%; width: 100%; height: 100%; display: table; padding: 1px 1px 1px 1px;">
                                                        ...
                                                        <div style="left: 0.5%; width: 50%; height: 100%; display: table-cell;">
                                                            <fieldset>
                                                                ...
                                                                <asp:TextBox ID="txtObservacoesNf" runat="server" MaxLength="1000" TextMode="MultiLine" Columns="50" Rows="6" Width="98%" />
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="gridRegistros">
                                                <asp:GridView ID="gvClientes" runat="server" TabIndex="52" DataKeyNames="clienteId,clienteTipoPessoa,clienteCNPJ,clienteIsentoIE,clienteIE,clienteCPF,clienteRG,clienteRazaoSocial,clienteNomeAbreviado,
                                                    ...
                                                    categoriaClienteId,categoriaClienteDescricao,mercadoId,mercadoDescricao,clienteInfoAtendentes,representanteId,representanteNomeAbreviado,representanteNome,medicoEnderecoCom,medicoNome,medicoMunicCom,medicoCEPCom,clienteRemConsig,BloqAudicon,AutorizaVacinas,AutorizaRetinoide,BloqMisoprostol,BloqFinanceiro,clienteIdSap, clientegrupoativo,Autoriza_Antibiotico,Autoriza_Imunosupressor,ZZCNAE"
                ...
                <div style="position: absolute;">
                    <asp:UpdatePanel ID="uppItem" runat="server" UpdateMode="Conditional">
                        ...
                        <ContentTemplate>
                                            ...
                                            <div class="gridRegistros">
                                                <asp:GridView ID="gvItensPesquisa" runat="server" TabIndex="55"
                                                    DataKeyNames="itemId,itemDescricao,itemInfComplementar,itemPesoBruto,itemPesoLiquido,itemRefrigerado,itemControlado,
                                                                ...
                                                                coeficienteDesconto,convenio87,tabelaPrecoImportacaoId,itemConv118,itemIsentoIcms,itemCodigoOrigem"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtObservacaoPedido" Enabled="false" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="navegacao">
                                                    <div class="boxPesquisa">
                                                        ...
                                                        <asp:TextBox ID="txtFiltroMedicoId" runat="server" SkinID="Filtro" MaxLength="30" TabIndex="8" />
                                                    </div>
                                                    <div class="boxPesquisa">
                                        ...
                                        <div class="gridRegistros">
                                            <asp:GridView ID="gvEmpenhoItens" runat="server"
                                                DataKeyNames="contratoLicitacaoId,clienteId,estabelecimentoId,contratoLicitacaoSeq,empenhoCodigoId,itemId,familiaComercialDescricao,empenhoItemQtd,
                                                                        ...
                                                                        empenhoItemSaldo,coeficienteDesconto,contratoLicitacaoData,convenio87,itemInfComplementar"
                                ...
                                <div class="painel_header">
                                    ...
                                    <div class="alert_header_icon">
                                        <asp:ImageButton ID="imbRemanejaReservasClose" runat="server" ImageAlign="AbsMiddle" Width="25px" Height="25px"
                                            ToolTip="<%$ Resources:Resource, lblFechar %>"
                                            ImageUrl="~/Imagens/Fechar.png"
                                            OnClick="imbRemanejaReservasClose_Click" />
                                    </div>
                                </div>
                                <div class="painel_body">
                        ...
                        <asp:UpdatePanel ID="updModal" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlModalUpload" runat="server" Visible="false" CssClass="Modal">
                                    <div id="ModalEscala" role="dialog" aria-labelledby="lblModalEscala" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">

                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <div class="alert_header_icon close">
                                                        <asp:ImageButton ID="btnCloseModal" runat="server" ImageAlign="AbsMiddle" Width="25px"
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-11 col-sm-11 col-xs-8">
                                                            <div class="x_panel">
                                                                <div class="x_title">
                                                                    <h2>
                                                                        <asp:Label ID="lblHeaderModalUpload" runat="server"></asp:Label></h2>
                                                                ...
                                                                <div class="x_content">
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <cc1:ProgressBar ID="pbUpload" runat="server" LabelFormat="{0}% Completo" ShowLabel="true" Animated="true" Striped="true" ProgressBarStyle="Success" MinimumValue="0" MaximumValue="100" CurrentValue="0" />
                                                                        <asp:Label ID="Label8" runat="server" Text=""></asp:Label>
                                                                         <asp:Button ID="btnprogress" Width="1px" Height="1px" Style="opacity: 0; margin-left: -1200px;" runat="server" Text="" OnClick="btnprogress_Click" />
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">
                                                            ...
                                                            <asp:Button Text="Cancelar" CssClass="btn btn-danger" ID="btnCancelaModal" OnClick="btnCancelaModal_Click" runat="server" />
                                                        </div>
                    ...
                    <ContentTemplate>
                        <script type="text/javascript">
                            function openLoad() {
                                ...
                                document.getElementById('<%= btnClickGrid.ClientID %>').click();
                            }
                        </script>
                        <%--   <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="updModalUpload">
                            <ProgressTemplate>
                                <div class="ProgressBackGround"></div>
                            </ProgressTemplate>
                        </asp:UpdateProgress>--%>
                            ...
                            <div id="myModal">
                                <div class="modal-dialog modal-md">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <asp:FileUpload ID="fulArquivo" runat="server" />
                                            <asp:Button ID="btnUpload" runat="server" SkinID="BtnPrimary" Text="<%$ Resources:Resource, lblCarregar %>" OnClick="btnUpload_Click" OnClientClick="openLoad();" />
                ...
                <asp:Panel ID="pnlPharmaSystem" runat="server" Visible="false" SkinID="PnlPopUp">
                    ...
                    <div class="painel" style="width: 40%; height: 55%; left: 30%; top: 20%;">
                        <div class="painel_header">
                            ...
                            <%--<div class="alert_header_icon">
                                <asp:ImageButton ID="imgClosePharmaSistem" runat="server" ImageAlign="AbsMiddle" Width="25px"
                                    Height="25px" TabIndex="28" ImageUrl="~/Imagens/Fechar.png" OnClick="imgClosePharmaSistem_Click" />
                            </div>--%>
                        </div>
                        <div class="painel_body">
                            <fieldset>
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h1> <asp:Label ID="lblIncoPedidoAmil" runat="server" Text="" /> </h1>
                                </div>
                                <div class="modal-body">
                                    <ol>
                                        <li>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <asp:TextBox ID="txtPedidoCompraAmil" runat="server" Font-Bold="true" SkinID="txtBootstrap2" Width="150px" MaxLength="15" />    </br>   
                                            </div>
                                        </li>
    ...
    <%--POPUP DE DETALHE PEDIDO--%>
    <div style="position: absolute;">
        <asp:UpdatePanel ID="updDetalhePedido" runat="server" UpdateMode="Conditional">

            <ContentTemplate>
                <asp:Panel ID="pnlDetalhePedido" Style="height: 80%;" runat="server" Visible="false" SkinID="PnlPopUp">

                    <div class="OpacityBackGround">
                    </div>
                    <%--<div class="painel">--%>
                    <div class="painel" style="width: 70%; height: 80%; left: 20%; top: 10%;">
                        <div class="painel_header">
                            <div class="painel_header_message">
                                <asp:Label ID="lblDetalhePedido" runat="server" ForeColor="White" />
                            </div>
                            <div class="alert_header_icon">
                                <asp:ImageButton ID="imgCloseDetalhePedido" runat="server" ImageAlign="AbsMiddle" Width="25px"
                                    Height="25px" TabIndex="28" ImageUrl="~/Imagens/Fechar.png" OnClick="imgCloseDetalhePedido_Click" />
                            </div>
                        </div>
                        <div class="painel_body">
                            <fieldset style="height: 20%;">

                                <div style="left: 0%; position: relative; width: 100%; height: 20%;">
                                    <br />
                                    <br />
                                    <ol>
                                        <li>
                                            ...
                                            <div class="line_itens">
                                                <asp:Label ID="lblPrazoDetalhe" runat="server" />
                                            </div>
                                            <div class="line_itens">
                                                <asp:DropDownList ID="ddlPrazoEntrega" runat="server" SkinID="DropSmallFilter">
                                                    <asp:ListItem Value="" Text="<%$ Resources:Resource, lblSelecione %>" Selected="True" />
                                        ...
                                        <li>--%>
                                            <div class="line_itens">
                                                <asp:Label ID="lblDataEntregaPedidoDetalhe" runat="server" />
                                            </div>
                                            <div class="line_itens">
                                                <CtlData:ControlData ID="CtlDataEntregaPedido" runat="server" ValidationGroup="Validacao" />
                                            </div>
                                            ...
                                            <div class="line_itens">
                                                <asp:Label ID="lblPeriodoDetalhe" runat="server" />
                                            </div>
                                        ...
                                        <li>
                                            <div class="line_itens">
                                                <asp:CheckBox ID="chkPedidoAgendado" runat="server" Font-Bold="true" TextAlign="Right" OnCheckedChanged="chkPedidoAgendado_CheckedChanged" AutoPostBack="true" />
                                            </div>
                                            <div class="line_itens">
                            ...
                            <fieldset style="height: 20%;">
                                ...
                                <ol>
                                    <li>
                                        <div style="left: 0%; position: relative; width: 99.5%; height: 100%; display: none">
                                            <div style="left: 0.5%; width: 50%; height: 100%; display: table-cell;">
                                                <div class="line_itens_left">
                                                    <asp:Label ID="lblTransportadoraDetalhe" runat="server" />
                                                </div>
                                                <div class="line_itens">
                                                    <asp:DropDownList ID="ddlTransportadora" Enabled="false" runat="server" SkinID="DropFiltro" AutoPostBack="true" OnSelectedIndexChanged="ddlTransportadora_SelectedIndexChanged" />
                                                </div>
                                            </div>
                                            <div style="left: 0.5%; width: 50%; height: 100%; display: table-cell; text-align: right;">
                                                <div style="margin-left: 10px;" class="line_itens_left">
                                                    <asp:Label ID="lblRedespacho" runat="server" />
                                                </div>
                                                <div class="line_itens">
                                                    <asp:DropDownList ID="dplRedespacho" Enabled="false" runat="server" SkinID="DropFiltro" AutoPostBack="true" OnSelectedIndexChanged="ddlTransportadora_SelectedIndexChanged" />
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="line_itens">
                                            <asp:CheckBox ID="chkEmergencial" runat="server" Font-Bold="true" Text="<%$ Resources:Resource, lblEmergencial %>"
                                                OnCheckedChanged="chkEmergencial_CheckedChanged"
                                                AutoPostBack="true" />
                                            <asp:CheckBox ID="chkTransportadoraOrcamento" runat="server" Font-Bold="true" Text="<%$ Resources:Resource, lblTransportadoraOrcamento %>" AutoPostBack="true" OnCheckedChanged="chkTransportadoraOrcamento_CheckedChanged" />
                                    
                                            <asp:CheckBox ID="chkAgendamentoEntrega" runat="server" Visible="true" Font-Bold="true" Text="<%$ Resources:Resource, lblAgendamentoEntrega %>" AutoPostBack="true" OnCheckedChanged="chkAgendamentoEntrega_CheckedChanged" />
                                ...
                                <ol>
                                    <li>
                                        <div class="line_itens">
                                            ...
                                            <%--<asp:TextBox ID="txtFreteAgrup" runat="server" SkinID="Currency80" MaxLength="14" Font-Bold="true" Enabled="false" />--%>
                                        ...
                                        <div class="line_itens">
                                            <asp:Label ID="lblTotalValorDetalhe" runat="server" />
                                            <asp:TextBox ID="txtTotalValorDetalhe" runat="server" SkinID="Currency100" MaxLength="50" Font-Bold="true" Enabled="false" />
                                        </div>
                                    </li>
                                </ol>
                            ...
                            <asp:Panel ID="pnlObservacao" runat="server">
                                <fieldset style="height: 30%;">
                                    ...
                                    <div style="left: 0.5%; width: 100%; height: 100%; display: table; padding: 1px 1px 1px 1px;">
                                        <%-- LEFT --%>
                                        <div style="left: 0.5%; width: 20%; height: 100%; display: table-cell;">
                                            <fieldset>
                                                <legend>
                                                    <asp:Literal ID="ltrObservacoesPedidoDetalhe" runat="server" />
                                                </legend>
                                                <asp:TextBox ID="txtObservacaoPedido" runat="server" MaxLength="255" TextMode="MultiLine" Columns="50" Rows="6" Width="98%" />
                                            </fieldset>
                                        </div>
                                        ...
                                        <div style="left: 0.5%; width: 20%; height: 100%; display: table-cell;">
                                            <fieldset>
                                                <legend>
                                                    <asp:Literal ID="ltrObservacoesNotaDetalhe" runat="server" />
                                                </legend>
                                        ...
                                        <div style="left: 0.5%; width: 20%; height: 100%; display: table-cell;">
                                            <fieldset>
                                                <legend>
                                                    <asp:Literal ID="ltrObservacoesEtiqueta" runat="server" />
                                                </legend>
                            ...
                            <div style="text-align: right; vertical-align: middle;">
                                <asp:HiddenField ID="hdIndexPedido" runat="server" />
                                <asp:Button ID="btnSalvarDetalhe" runat="server" OnClick="btnSalvarDetalhe_Click" />
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <asp:GridView ID="gvDetalhadoRegistros" Width="100%" AllowPaging="True" runat="server" TabIndex="7" SkinID="gvEstoquePaginadoDetalhado"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Estoque" ItemStyle-HorizontalAlign="Center" Visible="false" DataFormatString="{0:###,###,###,##0.##}" />
                                        ...
                                        <asp:BoundField DataField="Saldo" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:###,###,###,##0.##}" />
                                    </Columns>
                                    <PagerStyle CssClass="GridViewPagerStyle" HorizontalAlign="Center" />
                                </asp:GridView>
                            </div>
                            ...
                            <div class="modal-body">
                                ...
                                <asp:Panel ID="Panel2" runat="server" DefaultButton="btnfiltrar" SkinID="PnlMenu">
                                    <table border="0" cellspacing="1" cellpadding="1" style="vertical-align: baseline"
                                        ...
                                        <tr>
                                            <td>
                                                <CtlPeriodo:ControlPeriodo ID="dtAt" runat="server" MostraLinha="false" DataInicio="01/01/2012"
                                                    DataTermino="01/01/2012" />
                                            </td>
                                            <td valign="bottom">

<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadPedidoIntervan.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadPedidoIntervan" %>
                    ...
                    <fieldset style="margin-bottom: 110px; left: 0.1%; width: 99%; Height: 100%;">
                                    ...
                                    <asp:Panel ID="pnlFiltros" runat="server" SkinID="PnlMenu">
                                        <div style="display: table; text-align: center; width: 99%;">
                                            ...
                                            <div style="display: table; width: 100%; text-align: right;">
                                                ...
                                                <div class="navegacao">
                                                    <div class="boxPesquisa">
                                                        <asp:Label ID="lblFiltroLaboratorio" runat="server" />
                                                        <asp:DropDownList ID="dplFiltroLaboratorio" runat="server" TabIndex="12" SkinID="DropSmallFilter" />
                                                    </div>

                                                    <div class="boxPesquisa">
                                                        <asp:Button ID="btnFiltrosPesquisa" runat="server" SkinID="BtnSuccess" TabIndex="20"
                                                            OnClick="btnFiltrosPesquisa_Click" />
                                                        <asp:Button ID="btnFiltrosLimpar" runat="server" SkinID="BtnDanger" TabIndex="21"
                                                            OnClick="btnFiltrosLimpar_Click" />
                                                        <asp:Button ID="btnFiltrosNovoCadastro" runat="server" SkinID="BtnWarning" TabIndex="22"
                        ...
                        <div class="gridRegistros" style="margin-top: 10px; margin-bottom: 10px;">
                            <fieldset style="height: 30px; width: 98%; margin-bottom: 5px;">
                                <div style="display: table; text-align: left; width: 90%; height: 100%;">
                            ...
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="24" DataKeyNames="pedidoIdTotvs,pedidoId,clienteId,estabelecimentoId,clienteTipoPessoa,Autoriza_Psico,Autoriza_Medic,AutorizaRetinoide,AutorizaVacinas,clienteRemConsig,clienteIdERP,clienteContribuinteICMS,clienteGrupoComercialNome,pedidoSituacao,pedidoData,usuarioId,clienteCNPJ,clienteCPF,clienteRazaoSocial,tipoPagamento,ArquivoGerado,NomeArquivo,Autoriza_Antibiotico,Autoriza_Imunosupressor,Laboratorio,msgErroProcessamento"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="LABORATÓRIO" ItemStyle-Width="90px">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrLaboratorio" runat="server" Text='<%#  Eval("Laboratorio").ToString()  %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <fieldset>
                                    <div style="display: table; width: 100%;">
                                        ...
                                        <div style="text-align: right; display: table-cell; width: 50%; vertical-align: middle;">
                                            <asp:Button ID="btnSalvar" runat="server" SkinID="BtnSuccess" TabIndex="1" ValidationGroup="Validacao" OnClick="btnSalvar_Click" OnClientClick="this.disabled=true; __doPostBack(this.name, '');" />
                                            <asp:Button ID="btnLimpar" runat="server" SkinID="BtnDanger" TabIndex="6" OnClick="btnLimpar_Click" />
                                        <%--    <asp:ImageButton ID="imbReenviar" runat="server" Visible="false"
                                            ...
                                            <asp:ImageButton ID="imbDownload" runat="server" Width="25px" Height="25px" Style="margin-top: 10px;" Visible="false"
                                                CommandName="Download" OnClick="imbDownload_Click"
                                                ImageUrl="~/Imagens/download.png"
                                                ToolTip="<%$ Resources:Resource, lblDownload %>"  />--%>
                                            <asp:Button ID="btnVoltar" runat="server" SkinID="BtnDefault" TabIndex="8" OnClick="btnVoltar_Click"   />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                        ...
                                        <div style="width: 100%; display: table;">
                                            <asp:Panel ID="pnlLinha1" runat="server">
                                                ...
                                                <div style="width: 560px; display: table-cell; vertical-align: middle;">
                                                    <asp:Label ID="lblHeaderClienteTipoEndereco" runat="server" SkinID="LabelForm" Text="Tipo de endereço:" />
                                        ...
                                        <div style="width: 100%; display: table;">
                                            <asp:Panel ID="pnlLinha2" runat="server">
                                                ...
                                                <div style="width: 400px; display: table-cell;">
                                                   ...
                                                   <div style="width: 400px; display: table-cell;">
                                                    <div class="line_itens">
                                                        <asp:Label ID="lblLaboratorio" runat="server" Width="90px" />
                                                    </div>
                                                    <div class="line_itens">
                                                       <asp:DropDownList ID="dplLaboratorio" runat="server"

<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="CadPrefixoPedido.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadPrefixoPedido" %>
                        ...
                        <div class="alert_bottom_button">
                            <ol>
                                <li>
                                    ...
                                    <asp:TextBox ID="txtDadosUnidadeNegocioId" runat="server" MaxLength="3" width="50" TabIndex="1" />                                        
                                </li>
                                <li>
                                    <asp:Label ID="lblDadosUnidadeNegocioDescricao" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosUnidadeNegocioDescricao" runat="server" MaxLength="3" width="50" TabIndex="2" />                                        
                                </li>
                            </ol>
                            <div class="line">
                    ...
                    <fieldset>
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"
                                DataKeyNames="sistemaEntrada,prefixoSigla"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrUnidadeNegocioId" runat="server" Text='<%# FormataStringSaida(Eval("sistemaEntrada"), txtFiltrosUnidadeId.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrUnidadeNegocio" runat="server" Text='<%# FormataStringSaida(Eval("prefixoSigla"), txtFiltrosUnidadeDescricao.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>                                    

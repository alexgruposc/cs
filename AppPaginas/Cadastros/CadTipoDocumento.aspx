...
CodeBehind="CadTipoDocumento.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadTipoDocumento" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlCadastroTipoDocumento" runat="server">
        <asp:UpdatePanel ID="uppCadastroTipoDocumento" runat="server">
            <ContentTemplate>
                <%-- PROGRESS BACKGROUND --%>
                <asp:UpdateProgress ID="upLoading" runat="server" AssociatedUpdatePanelID="uppCadastroTipoDocumento">
                    <ProgressTemplate>
                ...
                <asp:Panel ID="pnlDados" runat="server" DefaultButton="btnSalvar" Visible="false">
                    <fieldset>
                        ...
                        <div class="alert_bottom_button">
                            <ol>
                                <li>
                                    <asp:Label ID="lblDadosTipoDocumentoId" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosTipoDocumentoId" runat="server" MaxLength="30" TabIndex="1" />
                                <li>
                                    <asp:Label ID="lblDadosTipoDocumentoDescricao" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosTipoDocumentoDescricao" runat="server" MaxLength="50" TabIndex="2" />
                                </li>                               
                            </ol>
                            <div class="line">
                                ...
                                <div class="painel">
                                    ...
                                    <div class="painel_body">
                                        <fieldset>
                                            ...
                                            <ol>
                                                <li>
                                                    <asp:Label ID="lblConfirmarDadosTipoDocumentoId" runat="server" SkinID="LabelForm" />
                                                    <asp:Label ID="lblConfirmarDadosTipoDocumentoIdTexto" runat="server" SkinID="LabelResposta" />
                                                </li>                                                
                                                <li>
                                                    <asp:Label ID="lblConfirmarDadosTipoDocumentoDescricao" runat="server" SkinID="LabelForm" />
                                                    <asp:Label ID="lblConfirmarDadosTipoDocumentoDescricaoTexto" runat="server" SkinID="LabelResposta" />
                                                </li>
                                            </ol>
                                        </fieldset>
                                    </div>
                    ...
                    <fieldset>
                        ...
                        <div class="navegacao">
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltroTipoDocumentoId" runat="server" />
                                <asp:TextBox ID="txtFiltroTipoDocumentoId" runat="server" SkinID="Filtro" MaxLength="30" TabIndex="8" />
                            </div>
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltroTipoDocumentoDescricao" runat="server" />
                                <asp:TextBox ID="txtFiltroTipoDocumentoDescricao" SkinID="Filtro" runat="server" MaxLength="50" TabIndex="9" />
                            </div>
                            <div class="boxPesquisa">
                                <div class="line">
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"                                 
                                DataKeyNames="tipoDocumentoId,tipoDocumentoDescricao" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrTipoDocumentoId" runat="server" Text='<%# FormataStringSaida(Eval("tipoDocumentoId"), txtFiltroTipoDocumentoId.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrTipoDocumentoDescricao" runat="server" Text='<%# FormataStringSaida(Eval("tipoDocumentoDescricao"), txtFiltroTipoDocumentoDescricao.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <%-- VALIDATION --%>
                <asp:RequiredFieldValidator ID="rfvTipoDocumentoId" runat="server" ControlToValidate="txtDadosTipoDocumentoId" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />
                <asp:RequiredFieldValidator ID="rfvTipoDocumentoDescricao" runat="server" ControlToValidate="txtDadosTipoDocumentoDescricao" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />

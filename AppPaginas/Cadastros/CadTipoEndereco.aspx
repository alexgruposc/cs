<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true"
    CodeBehind="CadTipoEndereco.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadTipoEndereco" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlCadastroTipoEndereco" runat="server">
        <asp:UpdatePanel ID="uppCadastroTipoEndereco" runat="server">
            <ContentTemplate>
                <%-- PROGRESS BACKGROUND --%>
                <asp:UpdateProgress ID="upLoading" runat="server" AssociatedUpdatePanelID="uppCadastroTipoEndereco">
                    <ProgressTemplate>
                ...
                <asp:Panel ID="pnlDados" runat="server" DefaultButton="btnSalvar" Visible="false">
                    <fieldset>
                        ...
                        <div class="alert_bottom_button">
                            <ol>
                                <li>
                                    <asp:Label ID="lblDadosTipoEnderecoId" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosTipoEnderecoId" runat="server" MaxLength="30" TabIndex="1" />
                                </li>
                                <li>
                                    <asp:Label ID="lblDadosTipoEnderecoDescricao" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosTipoEnderecoDescricao" runat="server" MaxLength="50" TabIndex="2" />
                                </li>
                            </ol>
                            <div class="line">
                                ...
                                <div class="painel">
                                    ...
                                    <div class="painel_body">
                                        <fieldset>
                                            ...
                                            <ol>
                                                <li>
                                                    <asp:Label ID="lblConfirmarTipoEnderecoId" runat="server" SkinID="LabelForm" />
                                                    <asp:Label ID="lblConfirmarTipoEnderecoIdTexto" runat="server" SkinID="LabelResposta" />
                                                </li>
                                                <li>
                                                    <asp:Label ID="lblConfirmarTipoEnderecoDescricao" runat="server" SkinID="LabelForm" />
                                                    <asp:Label ID="lblConfirmarTipoEnderecoDescricaoTexto" runat="server" SkinID="LabelResposta" />
                                                </li>
                                            </ol>
                                        </fieldset>
                                    </div>
                    ...
                    <fieldset>
                        ...
                        <div class="navegacao">
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltrosTipoEnderecoId" runat="server" />
                                <asp:TextBox ID="txtFiltrosTipoEnderecoId" runat="server" SkinID="Filtro" MaxLength="30" TabIndex="8" />
                            </div>
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltrosTipoEnderecoDescricao" runat="server" />
                                <asp:TextBox ID="txtFiltrosTipoEnderecoDescricao" runat="server" SkinID="Filtro" MaxLength="50" TabIndex="9" />
                            </div>
                            <div class="boxPesquisa">
                                <div class="line">
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16" 
                                DataKeyNames="tipoEnderecoId,tipoEnderecoDescricao"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrTipoEnderecoId" runat="server" Text='<%# FormataStringSaida(Eval("tipoEnderecoId"), txtFiltrosTipoEnderecoId.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrTipoEnderecoDescricao" runat="server" Text='<%# FormataStringSaida(Eval("tipoEnderecoDescricao"), txtFiltrosTipoEnderecoDescricao.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <%-- VALIDATION --%>
                <asp:RequiredFieldValidator ID="rfvTipoEnderecoId" runat="server" ControlToValidate="txtDadosTipoEnderecoId" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />
                <asp:RequiredFieldValidator ID="rfvTipoEnderecoDescricao" runat="server" ControlToValidate="txtDadosTipoEnderecoDescricao" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />

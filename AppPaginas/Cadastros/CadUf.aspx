...
CodeBehind="CadUf.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Cadastros.CadUf" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlCadastroUf" runat="server">
        <asp:UpdatePanel ID="uppCadastroUf" runat="server">
            <ContentTemplate>
                <%-- PROGRESS BACKGROUND --%>
                <asp:UpdateProgress ID="upLoading" runat="server" AssociatedUpdatePanelID="uppCadastroUf">
                    <ProgressTemplate>
                ...
                <asp:Panel ID="pnlDados" runat="server"  Visible="false">
                    <fieldset>
                        ...
                        <div class="alert_bottom_button">
                            <ol>
                                <li>
                                    <asp:Label ID="lblDadosUfId" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosUfId" runat="server" MaxLength="30" TabIndex="1" />
                                <li>
                                    <asp:Label ID="lblDadosEstadoNome" runat="server" SkinID="LabelForm" />
                                    <asp:TextBox ID="txtDadosEstadoNome" runat="server" MaxLength="50" TabIndex="2" />
                                </li>                               
                                <li>
                                    <asp:Label ID="lblDadosPaisId" runat="server" SkinID="LabelForm" />
                                    <asp:DropDownList ID="ddDadosPaisId" runat="server" MaxLength="30" TabIndex="3" />
                                <li>
                            </ol>
                            <div class="line">
                                ...
                                <div class="painel">
                                    ...
                                    <div class="painel_body">
                                        <fieldset>
                                            ...
                                            <ol>
                                                <li>
                                                    <asp:Label ID="lblConfirmarDadosUfId" runat="server" SkinID="LabelForm" />
                                                    <asp:Label ID="lblConfirmarDadosUfIdTexto" runat="server" SkinID="LabelResposta" />
                                                </li>                                                
                                                <li>
                                                    <asp:Label ID="lblConfirmarDadosEstadoNome" runat="server" SkinID="LabelForm" />
                                                    <asp:Label ID="lblConfirmarDadosEstadoNomeTexto" runat="server" SkinID="LabelResposta" />
                                                </li>
                                                <li>
                    ...
                    <fieldset>
                        ...
                        <div class="navegacao">
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltroUfId" runat="server" />
                                <asp:TextBox ID="txtFiltroUfId" runat="server" MaxLength="30" TabIndex="8" SkinID="Filtro" />
                            </div>
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltroEstadoNome" runat="server" />
                                <asp:TextBox ID="txtFiltroEstadoNome" runat="server" MaxLength="50" TabIndex="9" SkinID="Filtro" />
                            </div>
                            <div class="boxPesquisa">
                                <asp:Label ID="lblFiltroPaisId" runat="server" />
                                <asp:DropDownList ID="ddFiltroPaisId" runat="server" MaxLength="10" TabIndex="10" SkinID="DropFiltro" />
                            </div>
                            <div class="boxPesquisa">
                                <div class="line">
                        ...
                        <div class="gridRegistros">
                            <asp:GridView ID="gvRegistros" runat="server" TabIndex="16"                                 
                                DataKeyNames="ufId,estadoNome,paisId,paisNome" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrUfId" runat="server" Text='<%# FormataStringSaida(Eval("ufId"), txtFiltroUfId.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrEstadoNome" runat="server" Text='<%# FormataStringSaida(Eval("estadoNome"), txtFiltroEstadoNome.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Literal ID="ltrPaisNome" runat="server" Text='<%# FormataStringSaida(Eval("estadoNome"), txtFiltroEstadoNome.Text) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    --%>
                ...
                <%-- VALIDATION --%>
                <asp:RequiredFieldValidator ID="rfvUfId" runat="server" ControlToValidate="txtDadosUfId" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />
                <asp:RequiredFieldValidator ID="rfvEstadoNome" runat="server" ControlToValidate="txtDadosEstadoNome" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" />
                <%-- <asp:RequiredFieldValidator ID="rfvPaisId" runat="server" ControlToValidate="txtDadosPaisSigla" Display="None" SetFocusOnError="true" Text="*" ValidationGroup="Validacao" /> --%>

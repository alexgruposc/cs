<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="conRelatorioDescontoBoleto.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Consultas.conRelatorioDescontoBoleto" %>
                ...
                <asp:Panel ID="pnlFiltros" runat="server" Height="100%" DefaultButton="btnFiltorsPesquisar">
                    ...
                    <div style="left: 0.5%; width: 99%; height: 20%;">
                        <fieldset style="left: 0.5%; width: 99%;">
                            ...
                            <legend>
                                Relatório de Desconto de Boletos
                            </legend>
                        ...
                        <div style="width: 99%; margin-bottom: 5px; overflow-x: scroll;">
                            ...
                            <asp:GridView ID="grdReservas" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Cliente" HeaderText="Cliente" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Loja" HeaderText="Loja" ItemStyle-Width="6%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Data" HeaderText="Dt. Pedido" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Item ID" HeaderText="Item Id" ItemStyle-Width="6%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Desconto Boleto" HeaderText="Desconto Boleto" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Qtde" HeaderText="Quantidade" ItemStyle-Width="6%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="NF Numero" HeaderText="NF Numero" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="NF Serie" HeaderText="NF Serie" ItemStyle-Width="6%" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="Data Emiss Nota" HeaderText="Data Emiss Nota" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Left" />
                                </Columns>

<%@ Page Title="Relatório de Pedidos Fidelize - Autorizador" Language="C#" MasterPageFile="~/AppMaster/KraftMaster.Master" AutoEventWireup="true" CodeBehind="RelPedidosFidelize.aspx.cs" Inherits="KRAFTSALES.AppPaginas.Relatorios.RelPedidosFidelize" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlRelatorio" runat="server" Width="100%" Height="97%">
                ...
                <fieldset class="mt-2 pad-5">
                    ...
                    <legend>Relatório de Pedidos Fidelize - Autorizador</legend>

                    <div class="mt-2" style="padding-left: 5px">

                        <div class="colForm" style="width: 13%">
                            Nº Pedido Oncoprod:<br />
                            <asp:TextBox ID="txtSelPedidoId" runat="server" Width="80px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                        </div>

                        <div class="colForm bordaLeft" style="width: 13%">
                            Nº Pedido Fidelize:<br />
                            <asp:TextBox ID="txtSelOrderCode" runat="server" Width="80px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                        </div>
                        ...
                        <div class="colForm bordaLeft" style="width: 16%">
                            Laboratório:<br />
                            <asp:DropDownList ID="ddlSelFabricante" runat="server" Style="width: 98%" />
                        </div>

                        <div class="colForm bordaLeft" style="width: 16%">
                            Status Oncoprod:<br />
                            <asp:DropDownList ID="ddlSelPedidoSituacao" runat="server" Style="width: 98%" />
                        </div>

                        <div class="colForm bordaLeft" style="width: 16%">
                            Status Fidelize:<br />
                            <asp:DropDownList ID="ddlSelStatusFidelize" runat="server" Style="width: 98%" />
                        </div>
